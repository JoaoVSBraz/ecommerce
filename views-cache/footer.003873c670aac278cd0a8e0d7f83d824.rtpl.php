...
<!-- jQuery sticky menu -->
<script src="/ecommerce/src/js/owl.carousel.min.js"></script>
<script src="/ecommerce/src/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/ecommerce/src/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/ecommerce/src/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/ecommerce/src/js/bxslider.min.js"></script>
<script type="text/javascript" src="/ecommerce/src/js/script.slider.js"></script>
</body>
</html>